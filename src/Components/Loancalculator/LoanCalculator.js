            ...
            <Container className="show-grid mainContainer">
                <Row>
                    <Col className="leftSide" xs={12} md={6}>
                        ...
                        <Col className="logo" sm={12}> <br/>
                        <img            
                         src="https://www.natwest.com/content/dam/natwest_com/navigation/header/natwest-logo.png"
                         alt="First slide"
                        />
                        </Col>
                    </Col>
...
LoanCalculator.propTypes = {
    ...
    valueD: React.PropTypes,
    stepD: React.PropTypes,
    maxD: React.PropTypes,
    minD: React.PropTypes,

    valueA: React.PropTypes,
    stepA: React.PropTypes,
    maxA: React.PropTypes,
    minA: React.PropTypes,
    APR1: React.PropTypes,
    APR2: React.PropTypes,
    APR3: React.PropTypes,
    currancy: React.PropTypes,
};
